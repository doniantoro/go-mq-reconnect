...
// 		go func() {
// 			for {
// 				reason, ok := <-channel.Wabbit.NotifyClose(make(chan wabbit.Error))
// 				// exit this goroutine if closed by developer
// 				if !ok || channel.IsClosed() {
// 					log.Println("channel closed")
// 					channel.Wabbit.Close() // close again, ensure closed flag set when connection closed
// 					break
// 				}
